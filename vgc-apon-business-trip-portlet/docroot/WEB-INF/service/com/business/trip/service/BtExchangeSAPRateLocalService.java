...
/**
 * Provides the local service interface for BtExchangeSAPRate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BtExchangeSAPRateLocalServiceUtil
...
public interface BtExchangeSAPRateLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BtExchangeSAPRateLocalServiceUtil} to access the bt exchange s a p rate local service. Add custom service methods to {@link com.business.trip.service.impl.BtExchangeSAPRateLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
