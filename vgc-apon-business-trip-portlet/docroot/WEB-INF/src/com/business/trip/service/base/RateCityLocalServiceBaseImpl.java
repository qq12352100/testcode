...
import com.business.trip.service.RateCityLocalService;
...
/**
 * Provides the base implementation for the rate city local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.business.trip.service.impl.RateCityLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.business.trip.service.impl.RateCityLocalServiceImpl
 * @see com.business.trip.service.RateCityLocalServiceUtil
 * @generated
 */
public abstract class RateCityLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements RateCityLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.business.trip.service.RateCityLocalServiceUtil} to access the rate city local service.
	 */
	...
	@Override
	public RateCity addRateCity(RateCity rateCity) throws SystemException {
		rateCity.setNew(true);

		return rateCityPersistence.update(rateCity);
	}
	 ...
	 */
	@Override
	public RateCity createRateCity(long ratecityId) {
		return rateCityPersistence.create(ratecityId);
	}
	...
	@Override
	public RateCity deleteRateCity(long ratecityId)
		throws PortalException, SystemException {
		return rateCityPersistence.remove(ratecityId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public RateCity deleteRateCity(RateCity rateCity) throws SystemException {
		return rateCityPersistence.remove(rateCity);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(RateCity.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return rateCityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return rateCityPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return rateCityPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return rateCityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public RateCity fetchRateCity(long ratecityId) throws SystemException {
		return rateCityPersistence.fetchByPrimaryKey(ratecityId);
	}
	 ...
	 */
	@Override
	public RateCity getRateCity(long ratecityId)
		throws PortalException, SystemException {
		return rateCityPersistence.findByPrimaryKey(ratecityId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return rateCityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<RateCity> getRateCities(int start, int end)
		throws SystemException {
		return rateCityPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getRateCitiesCount() throws SystemException {
		return rateCityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public RateCity updateRateCity(RateCity rateCity) throws SystemException {
		return rateCityPersistence.update(rateCity);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.business.trip.model.RateCity",
			rateCityLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = rateCityPersistence.getDataSource();
	...
	private RateCityLocalServiceClpInvoker _clpInvoker = new RateCityLocalServiceClpInvoker();
}