		...
		<div class="mainbody">
		    <div class="newtb">
		    	...
		    	<ul>
		    	    ...
		    	    <li class="nd02">
		    	        <input id="d4311" class="Wdate" type="text" maxlength="75"
		    	    ...
		    	    <li class="nd02">
		    	        <input id="d4312" class="Wdate" type="text" maxlength="75"
		    	...
		    	<ul>
		    	 <li class="nd02">
		    	    ...
		    	    <li class="nd02">
		    	    	<input type="text" name="<portlet:namespace/>price" id="price" onblur="checkFloat(this)"  onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" value="<%=isNew?"": String.format("%.2f", btCarRentalInfo.getPrice()) %>" maxlength="75"/>
		    	    </li>
		    	    <li class="nd02">
