...
/**
 * This class is used by SOAP remote services, specifically {@link com.company.car.service.http.FirstCompanyCarServiceSoap}.
 *
 * @author Brian Wing Shun Chan
 * @see com.company.car.service.http.FirstCompanyCarServiceSoap
 * @generated
 */
public class FirstCompanyCarSoap implements Serializable {
	public static FirstCompanyCarSoap toSoapModel(FirstCompanyCar model) {
		FirstCompanyCarSoap soapModel = new FirstCompanyCarSoap();

		soapModel.setFirstCompanyCarId(model.getFirstCompanyCarId());
		...
		soapModel.setChildrenNumber(model.getChildrenNumber());
	...
	public static FirstCompanyCarSoap[] toSoapModels(FirstCompanyCar[] models) {
		FirstCompanyCarSoap[] soapModels = new FirstCompanyCarSoap[models.length];
	...
	public static FirstCompanyCarSoap[][] toSoapModels(
		FirstCompanyCar[][] models) {
		FirstCompanyCarSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new FirstCompanyCarSoap[models.length][models[0].length];
		}
		else {
			soapModels = new FirstCompanyCarSoap[0][0];
		}
	...
	public static FirstCompanyCarSoap[] toSoapModels(
		List<FirstCompanyCar> models) {
		List<FirstCompanyCarSoap> soapModels = new ArrayList<FirstCompanyCarSoap>(models.size());

		for (FirstCompanyCar model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new FirstCompanyCarSoap[soapModels.size()]);
	}

	public FirstCompanyCarSoap() {
	}
