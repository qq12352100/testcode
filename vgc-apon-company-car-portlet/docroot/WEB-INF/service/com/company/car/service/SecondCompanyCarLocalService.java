...
/**
 * Provides the local service interface for SecondCompanyCar. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SecondCompanyCarLocalServiceUtil
...
public interface SecondCompanyCarLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SecondCompanyCarLocalServiceUtil} to access the second company car local service. Add custom service methods to {@link com.company.car.service.impl.SecondCompanyCarLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
