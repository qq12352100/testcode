...
import com.company.car.service.FirstCompanyCarLocalService;
...
/**
 * Provides the base implementation for the first company car local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.company.car.service.impl.FirstCompanyCarLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.company.car.service.impl.FirstCompanyCarLocalServiceImpl
 * @see com.company.car.service.FirstCompanyCarLocalServiceUtil
 * @generated
 */
public abstract class FirstCompanyCarLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FirstCompanyCarLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.company.car.service.FirstCompanyCarLocalServiceUtil} to access the first company car local service.
	 */
	...
	@Override
	public FirstCompanyCar addFirstCompanyCar(FirstCompanyCar firstCompanyCar)
		throws SystemException {
		firstCompanyCar.setNew(true);

		return firstCompanyCarPersistence.update(firstCompanyCar);
	}
	 ...
	 */
	@Override
	public FirstCompanyCar createFirstCompanyCar(long firstCompanyCarId) {
		return firstCompanyCarPersistence.create(firstCompanyCarId);
	}
	...
	@Override
	public FirstCompanyCar deleteFirstCompanyCar(long firstCompanyCarId)
		throws PortalException, SystemException {
		return firstCompanyCarPersistence.remove(firstCompanyCarId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FirstCompanyCar deleteFirstCompanyCar(
		FirstCompanyCar firstCompanyCar) throws SystemException {
		return firstCompanyCarPersistence.remove(firstCompanyCar);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FirstCompanyCar.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return firstCompanyCarPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return firstCompanyCarPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FirstCompanyCar fetchFirstCompanyCar(long firstCompanyCarId)
		throws SystemException {
		return firstCompanyCarPersistence.fetchByPrimaryKey(firstCompanyCarId);
	}
	 ...
	 */
	@Override
	public FirstCompanyCar getFirstCompanyCar(long firstCompanyCarId)
		throws PortalException, SystemException {
		return firstCompanyCarPersistence.findByPrimaryKey(firstCompanyCarId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return firstCompanyCarPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FirstCompanyCar> getFirstCompanyCars(int start, int end)
		throws SystemException {
		return firstCompanyCarPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFirstCompanyCarsCount() throws SystemException {
		return firstCompanyCarPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.company.car.model.FirstCompanyCar",
			firstCompanyCarLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = firstCompanyCarPersistence.getDataSource();
	...
	private FirstCompanyCarLocalServiceClpInvoker _clpInvoker = new FirstCompanyCarLocalServiceClpInvoker();
}