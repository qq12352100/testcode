...
public class SecondCompanyCarWorkflowHandler extends BaseWorkflowHandler {
	...
	public Object updateStatus(int status,
		...
		long secondCompanyCarId = GetterUtil.getLong((String) workflowContext
				.get(WorkflowConstants.CONTEXT_ENTRY_CLASS_PK));

		ServiceContext serviceContext = (ServiceContext) workflowContext
				.get("serviceContext");

		return SecondCompanyCarLocalServiceUtil.updateStatus(userId,
