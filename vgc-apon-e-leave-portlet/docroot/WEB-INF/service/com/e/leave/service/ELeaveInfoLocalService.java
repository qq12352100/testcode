...
/**
 * Provides the local service interface for ELeaveInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author EZEYIFE
 * @see ELeaveInfoLocalServiceUtil
...
public interface ELeaveInfoLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ELeaveInfoLocalServiceUtil} to access the e leave info local service. Add custom service methods to {@link com.e.leave.service.impl.ELeaveInfoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
