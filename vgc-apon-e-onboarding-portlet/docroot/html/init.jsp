...
<%@page import="com.e.onboarding.util.ContractTypeEnum"%>
<%@page import="com.vgc.apon.model.SAPUser"%>
<%@page import="com.e.onboarding.service.EOnBoardingLocalServiceUtil"%>
<%@page import="com.e.onboarding.model.EOnBoarding"%>
<%@page import="com.e.onboarding.constant.ApplicantConstrant"%>
...
<%@page import="com.vgc.apon.model.SAPUser"%>
<%@page import="com.e.onboarding.constant.ApplicantConstrant"%>
<%@page import="com.vgc.apon.service.SapPositionLocalServiceUtil"%>
<%@page import="com.vgc.apon.model.SapPosition"%>

<%@ taglib uri="http://java.sun.com/portlet_2_0" prefix="portlet" %>

<%@page import="com.e.onboarding.service.DistributionLocalServiceUtil"%>
<%@page import="com.e.onboarding.model.Distribution"%>
<%@page import="com.liferay.portal.kernel.dao.search.RowChecker"%>
<%@page import="com.e.onboarding.search.distribution.DistributionChecker" %>
<%@ taglib uri="http://java.sun.com/portlet_2_0" prefix="portlet"%>
...
<%@page import="com.e.onboarding.util.EmployeeSubGroupIDPersonalGradeEnum" %>
