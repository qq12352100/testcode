...
/**
 * Provides the local service interface for ETransfer. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author EZEYIFE
 * @see ETransferLocalServiceUtil
...
public interface ETransferLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ETransferLocalServiceUtil} to access the e transfer local service. Add custom service methods to {@link com.e.transfer.service.impl.ETransferLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
