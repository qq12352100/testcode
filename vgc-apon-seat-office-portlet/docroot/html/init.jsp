...
<%@ page import="com.seatoffice.service.SeatOfficeLocalServiceUtil" %>
<%@ page import="com.seatoffice.model.SeatOffice" %>
<%@ page import="com.seatoffice.util.OfficeSiteEnum" %>
<%@ page import="com.seatoffice.util.ContractTypeEnum" %>
<%@ page import="com.seatoffice.util.EmployeeSubGroupIDPersonalGradeEnum" %>
<%@
...
<%@page import="com.seatoffice.util.SeatOfficeCategoryEnum" %>
<%@page import="com.global.management.model.WorkSpaceManagement" %>
<%@page import="com.global.management.service.WorkSpaceManagementLocalServiceUtil" %>
